...
function trackMinigamesTabClick(){if(!tutorialData.completed&&tutorialData.currentStep===13&&tutorialData.steps[13].id==='explore_minigames'){console.log('🎓 Minigames tab clicked! Auto-advancing tutorial.');nextTutorialStep()}}
