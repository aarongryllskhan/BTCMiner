...
// ============================================================================
// CHART INITIALIZATION - Sets up the net worth graph with Chart.js
// ============================================================================

function initChart() {
    const canvasEl = document.getElementById('nwChart');
    if (!canvasEl) {
        console.error('ERROR: Canvas element #nwChart not found');
        return null;
    }
...
// Try immediate initialization after DOM loads
